...
import devinu33.udemy.todocompose.components.PriorityItem
...
import devinu33.udemy.todocompose.util.TrailingIconState
...
fun SearchAppBar(
    ...
    Surface(
        modifier = Modifier
            .fillMaxWidth()
            .height(TOP_APP_BAR_HEIGHT), //material top bar spec height
        ...
        TextField(
            ...
            onValueChange = {
                trailingIconState =
                    if (it.isNotEmpty()) TrailingIconState.READY_TO_DELETE else TrailingIconState.READY_TO_CLOSE
                onTextChange(it)
            },
            placeholder = {
                Text(
